...
<html lang="en">
  <head>
    ...
    <link rel="<?php echo base_url()."asserts/shortcut icon"?>" href="<?php echo base_url()."asserts/img/favicon.png"?>">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="<?php echo base_url()."Login1"?>"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
                            <li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url()."General"?>">Components</a></li>
  ...
  <!-- container section end -->
    ...
    <script src="<?php echo base_url()."asserts/js/gritter.js"?>" type="text/javascript"></script>
