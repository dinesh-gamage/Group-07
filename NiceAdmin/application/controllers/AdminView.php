...
class AdminView extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/admin_view_home',$data);
    ...
    public function getPatient()
    {
        ...
        $data1['doc_data'] = $this->profilemodel->get_admin_data();
        $this->load->view('main/admin_header',$data1);
		$this->load->view('admin/admin_view_patient',$data);
    }
...
//        redirect(base_url('AdminView'));
                        ...
                        $res = '
                                    <div id="">
                                            <h4 class="text-center">Search  Results</h4><hr>
                                                <form name="myform" id="myform" action="'.base_url().'/AdminView/getPatient/" method="post">
   ...
   public function viewDoc(){
        if (isset($_POST['viewd'])) {
           ...
           foreach ($view as $viewd) {
               $res = '
                    <br/>
                    <br/>
                    <div class="panel panel-info" style="height:332px;">
                        <div class="panel-heading">
                          <h3 class="panel-title">'.$viewd->doc_name.'</h3>
                        </div>
                        <div class="panel-body" style="height:290px;">
                          <div class="row">
                            <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="'.base_url().''.$viewd->doc_img.'" class="img-circle img-responsive"> </div>
                            <div class=" col-md-9 col-lg-9 "> 
                              <table class="table table-user-information">
                                <tbody>
                                  <tr>
                                    <td>Username:</td>
                                    <td>'.$viewd->user_name.'</td>
                                  </tr>
                                  <tr>
                                    <td>Speciality:</td>
                                    <td>'.$viewd->speciality.'</td>
                                  </tr>
                                  <tr>
                                    <td>Contact Number</td>
                                    <td>'.$viewd->telephone.'</td>
                                  </tr>
                                  <tr>
                                    <td>Email</td>
                                    <td><a href="'.$viewd->email.'">'.$viewd->email.'</a></td>
                                  </tr>
   ...
   public function viewNur(){
        if (isset($_POST['viewn'])) {
           ...
           foreach ($view as $viewn) {
               $res = '
                        <br/>
                    <br/>
                    <div class="panel panel-info" style="height:332px;">
                        <div class="panel-heading">
                          <h3 class="panel-title">'.$viewn->nurse_name.'</h3>
                        </div>
                        <div class="panel-body" style="height:290px;">
                          <div class="row">
                            <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="'.base_url().''.$viewn->nur_image.'" class="img-circle img-responsive"> </div>
                            <div class=" col-md-9 col-lg-9 "> 
                              <table class="table table-user-information">
                                <tbody>
                                  <tr>
                                    <td>Username:</td>
                                    <td>'.$viewn->user_name.'</td>
                                  </tr>
                                  <tr>
                                    <td>Contact Number</td>
                                    <td>'.$viewn->telephone.'</td>
                                  </tr>
                                  <tr>
                                    <td>Email</td>
                                    <td><a href="'.$viewn->email.'">'.$viewn->email.'</a></td>
                                  </tr>
