...
<html lang="en-us">
  <head>
    ...
    <script src="<?php echo base_url(); ?>Build/UnityLoader.js"></script>
    <script>
      var gameInstance = UnityLoader.instantiate("gameContainer", "<?php echo base_url()."Build/build.json"; ?>", {onProgress: UnityProgress});
    </script>
  </head>
  <body>
