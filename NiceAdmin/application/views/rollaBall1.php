...
<html lang="en-us">
  <head>
    ...
    <script src="<?php echo base_url(); ?>Build-roll1/UnityLoader.js"></script>
    <script>
      var gameInstance = UnityLoader.instantiate("gameContainer", "<?php echo base_url()."Build-roll1/RollaBall-level1.json"; ?>", {onProgress: UnityProgress});
    </script>
  </head>
  <body>
    <div class="webgl-content">
      ...
      <div class="footer">
        ...
        <div class="title">Roll a Ball - level1</div>
      </div>
    </div>
  </body>
</html>
