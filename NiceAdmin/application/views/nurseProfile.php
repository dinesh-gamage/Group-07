                      ...
                      <div id="profile" class="tab-pane active">
                        <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <div class="row">
                                  <div class="bio-row">
                                      <p><span>Name </span>: <?=$row->nurse_name?> </p>
                                  </div>
                                  <div class="bio-row">
                      ...
                      <div id="edit-profile" class="tab-pane">
                        <section class="panel">
                              <div class="panel-body bio-graph-info">
                                  ...
                                  ?>
                                      <?php echo form_open_multipart('nurseProfile',$formopendoc)?>
                                      <div class="">
...
$(document).ready(function (){
  ...
  $('#curpass').keyup(function (){
      ...
      $.ajax({
          type: "post",
          url: "http://[::1]/project/Group-07/NiceAdmin/NurseProfile/index/",
          cache: false,
          data: {curpass: curr},
