                          ...
                          <div class="panel-body">
                            <div class="col-lg-2 col-sm-2">
                              ...
                              <div class="follow-ava">
                                  <img src="<?php echo base_url()."asserts/img/profile-widget-avatar.jpg"?>" alt="">
                              </div>
                              <h6>Administrator</h6>
                            </div>
                                      ...
                                      <div class="profile-activity">                                          
                                          <div class="act-time">                                      
                                              <div class="activity-body act-in">
                                                  ...
                                                  <div class="text">
                                                      <a href="#" class="activity-img"><img class="avatar" src="<?php echo base_url()."asserts/img/chat-avatar.jpg"?>" alt=""></a>
