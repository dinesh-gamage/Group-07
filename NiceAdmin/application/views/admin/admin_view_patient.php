...
<section class="wrapper">
    <div class="contentContainer">
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="<?php echo base_url() . "AdminView" ?>">Home </a></li>                  
                ...
                <div id="diagnosis" style="display: none" >
                    <div class="white_back">
                        ...
                        <?php 
                            ...
                            echo form_open('AdminView/add_diagnosis',$attri);
                        ?>
                    ...
                    <div class="white_back">
                        ...
                        <?php 
                            $attri = array('class'=>'form-horizontal');
                            echo form_open('AdminView/add_problem',$attri);
                        ?>
                            ...
                            <div id="family" class="tab-pane fade in active">
                                <div class="white_back">
                                    ...
                                    <?php
                                        ...
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_family_history',$attri);
                                    ?>
...
<!-- display communication skills -->
                            <div id="comm" class="tab-pane fade">
                                <div class="white_back">
                                    ...
                                    <?php 
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_communication_skills',$attri);
                                    ?>
                            ...
                            <div id="mortor" class="tab-pane fade">
                                <div class="white_back">
                                    ...
                                    <?php 
                                        ...
                                        echo form_open('AdminView/add_motor_skills',$attri);
                                    ?>
...
<!-- display cognative skills --> 
                            <div id="cog" class="tab-pane fade">
                                <div class="white_back">
                                    ...
                                    <?php 
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_cognitive_skills',$attri);
                                    ?>
...
<!-- display cognative skills --> 
                            <div id="case_notes" class="tab-pane fade">
                                <div class="white_back">
                                    ...
                                    <?php 
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_case_notes',$attri);
                                    ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="setGoals" class="tab-pane fade in active">
                                ...
                                <h3 class="text-center">Set Goals</h3><hr>
                                    <?php 
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_goals',$attri);
                                    ?>
...
<!--                                    <form method="get" >-->
                                   <?php 
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_goal_marks',$attri);
                                    ?>
                                    <?php
//                                        
...
<!--                                    <form method="get" >-->
                                   <?php 
                                        $attri = array('class'=>'form-horizontal');
                                        echo form_open('AdminView/add_doc_notes',$attri);
                                    ?>
                 ...
                 <!--    </div> -->
                    <!-- <div class="white_back container">
                        ...
                        <?php 
                            ...
                            echo form_open('AdminView/add_final_marks',$attri);
                        ?>
