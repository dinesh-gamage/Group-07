                ...
                <div class="white_back container" style="overflow-y:auto; height: 527px;">
                    ...
                    <div id="newPatientList">
                        ...
                        ?>
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url() ?>/AdminView/getPatient/" method="post">
                  ...
                  <div class="modal-dialog" role="document">
                    ...
                    <!--form class="form-horizontal" method="POST" action="<!?php echo base_url()."Calendar/add_data";?>"-->
                      <?php 
                        ...
                        echo form_open('AdminView/add_data',$attri);?>
                ...
                <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        echo form_open('AdminView/edit_data',$attri);?>
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  $(document).ready(function() {
    ...
    function edit(event){
      ...
      id =  event.id;
            title = event.title;
      $.ajax({
       url: 'http://[::1]/project/Group-07/NiceAdmin/AdminView/edit_event',
       type: "POST",
...
<script type="text/javascript">
  $('#searchButton').click(function(){
      ...
      $.ajax({
         url: 'http://[::1]/project/Group-07/NiceAdmin/AdminView/search',
         type: "POST",
