                    ...
                    <div id="caseHistory">
                        <div class="col-md-12">
                                ...
                                <ul class="nav nav-pills nav-justified">
                                    ...
                                    <li><a data-toggle="pill" href="#notes">Case_notes</a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="comm" class="tab-pane fade">
                                        ...
                                        <?php
                                        foreach ($allComm as $communication):
                                        ...
                                        echo form_open('DoctorView/add_communication_skills',$attri);?>
                                            ...
                                            <hr><h4> Oral Skills / Examination</h4><hr>
                                            <div class="form-group">
